# Deploy wxo adk external-agent to software hub default dataplane
...
```
4. Copy the contents from the provided file in this folder and paste them into app-proxy-config.yaml.
5. Go back to the cpd-cli directory:
```
cd ../../..
```
